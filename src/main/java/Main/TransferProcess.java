...
/***/
		for(WorkflowImpl w:workflows) {
			...
			String path = "./Evaluation/GreedyTransferProcess/abstractResults(DEC)/";
...
/**--*/
	...
	public static HashMap<NodeInterface, NodeInterface> getAnalogicalMapping(){
		...
		File file = new File("/home/xinyuan/download/Analoge Mappings/Masterarbeit Nils Gormsen/analogical mapping");
		Scanner scanner;
		try {
